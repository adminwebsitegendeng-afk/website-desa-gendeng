...
const initialWisata: WisataRecord[] = [
  ...
  },
  {
    ...
    location: "Gendeng, Gondokusuman",
    description: "Lorong penuh warna karya warga yang menjadi ikon kreatif Kampung Gendeng.",
...
const initialPotensi: PotensiRecord[] = [
  {
    ...
    description: "Keripik tempe renyah buatan warga Kampung Gendeng.",
    coverImage: "/images/potensi_crafts.png",
    status: "published",
  },
  {
...
const initialProfil: ProfilRecord = {
  ...
  historyText: "Kampung Gendeng terbentuk secara administratif dari penggabungan wilayah pemukiman asri di Kecamatan Gondokusuman, Yogyakarta.",
  visionText: "Terwujudnya Kampung Gendeng yang Maju, Mandiri, Sejahtera, Berkarakter Budaya Luhur, dan Unggul dalam Sektor Agribisnis Terpadu pada Tahun 2030.",
  missionList: [
...
const initialHomepage: HomepageRecord = {
  ...
  heroDesc: "Kampung Gendeng adalah kampung yang maju, mandiri, berbudaya dan terbuka untuk dunia.",
