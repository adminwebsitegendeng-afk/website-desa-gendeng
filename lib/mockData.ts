...
export const touristSpots: TouristSpot[] = [
  ...
  },
  {
    ...
    location: "Halaman Balai Desa Gendeng",
...
export const newsArticles: NewsArticle[] = [
  {
    id: "news-1",
    title: "Pemerintah Desa Gendeng Luncurkan Program Ketahanan Pangan 2026",
  ...
  },
  {
    ...
    excerpt: "Bekerja sama dengan dinas koperasi, BUMDesa Gendeng menyelenggarakan workshop pembuatan toko online dan manajemen pemasaran digital.",
    content: `Guna mendongkrak omzet pelaku Usaha Mikro Kecil dan Menengah (UMKM), terutama perajin serat alam dan bambu di Desa Gendeng, BUMDesa Gendeng Makmur mengadakan pelatihan pemasaran digital terpadu.\n\nPelatihan ini berlangsung selama dua hari di Aula Balai Desa dengan menghadirkan narasumber ahli praktisi e-commerce nasional. Sebanyak 30 pelaku UMKM lokal diajarkan cara memfoto produk secara menarik, menulis deskripsi produk yang memikat, mengelola akun toko online di berbagai marketplace, serta memanfaatkan media sosial untuk promosi.\n\nCarik Desa Gendeng, Sri Mulyani, S.E., menuturkan bahwa potensi kerajinan bambu Desa Gendeng sangat besar, namun terkendala dalam jangkauan pasar yang masih lokal.\n\n"Dengan go-digital, kami berharap produk-produk unggulan dari Desa Gendeng ini bisa menjangkau pembeli di kota-kota besar di seluruh Indonesia bahkan diekspor secara langsung melalui platform digital," imbuhnya.`,
    date: "2026-07-25",
  ...
  },
  {
    ...
    content: `Akses transportasi pertanian dan mobilitas warga di Dusun Gendeng Wetan kini semakin lancar setelah proyek pembangunan jalan rabat beton rampung 100%.\n\nPembangunan infrastruktur jalan sepanjang 1.200 meter dengan lebar 3 meter ini menggunakan anggaran Dana Desa Gendeng Tahap I tahun 2026. Pengerjaan dilakukan secara swakelola dengan melibatkan warga dusun setempat sebagai wujud padat karya tunai.\n\nKepala Seksi Kesejahteraan Desa Gendeng, Ahmad Dahlan, menjelaskan bahwa sebelumnya kondisi jalan tanah tersebut sangat memprihatinkan, licin, dan berlumpur ketika musim hujan, menghambat distribusi hasil panen padi dan kelapa milik petani.\n\n"Alhamdulillah, dengan gotong royong yang luar biasa, jalan ini selesai tepat waktu dalam waktu 3 minggu. Kini petani bisa membawa hasil panen ke pasar secara lebih cepat dan hemat ongkos angkut," ungkap Ahmad Dahlan.`,
    date: "2026-07-10",
    author: "Ahmad Dahlan",
    category: "Pembangunan",
